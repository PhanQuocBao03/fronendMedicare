                    ...
                    <div>
                        <div className="lg:w-[570px]">
                            <h1 className="text-[36px] leading-[46px]  text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
                                We help patients live a  headthy , logger life.
                            </h1>
                            <p className="text__para">Lolen ipsum dolor sit amet  consectour, adipisicing elit</p>
                        ...
                        <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
                            ...
                            <div>
                                ...
                                <span className="w-[100px] h-2 bg-purplerColor rounded-full block mt-[-14px]"></span>
                                <p className="text__para">Clinic Location</p>
                            </div>
                            <div>
                                <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor">100%</h2>
                                <span className="w-[100px] h-2 bg-irisBlueColor rounded-full block mt-[-14px]"></span>
                                <p className="text__para">Patient Staticfaction</p>
                            </div>
                        </div>
                        ...
                        <div className="py-[30px] px-5">
                            ...
                            <div className="mt-[30px]">
                                ...
                                <p className="text-[16px] leading-7 font-[400] text-textColor mt-4 text-center">
                                    ...
                                    offers umatched, expect health care.From the lab to the clinic.
                                </p>
            ...
            <div className="flex justify-between gap-[50px] lg:gap-0">
                ...
                <div className="w-full md:w-1/2">
                    <div className="heading">
                        <h2>More question by our beloveed patients</h2>
                        <FaqList/>
                    </div>
                </div>
            </div>
