                                    ...
                                    data.isApproved ==="pending" && (
                                        <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                                            ...
                                            <div className="ml-3 text-sm font-medium">
                                                To get approval please complete your profile. We&apos;ll review manualy and approve withinn 3days 
                                            </div>
                                    ...
                                    <div className="flex items-center gap-4 mb-10">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex text-center gap-[16px]">
                                                <span className="flex text-center gap-[16px] text-headingColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold" >
                                                    <img src={startIcon} alt="" />{data.averageRating}
                                                </span>
                                                <span className=" text-textColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold" >
                                                    ({data.totalRating})
                                                </span>
                                            </div>
                                            <div className="text__para font-[15px] lg:max-w-[390px] leading-6">{data?.bio}</div>
                                        </div>
                                    </div>
                                    <DoctorAbout
                                        name ={data.name}
